...
public class Alquiler implements Serializable{
	...
	public void fichaAlquiler() {
		...
		System.out.println("HA SIDO ALQUILADO POR EL EMPLEADO "+nom_emple.toUpperCase()+" EN LA OFICINA "+cod_ofi_dev.toUpperCase()+" CON UN PRECIO TOTAL DE "+this.precio_final+"€");
		interfaz.pinta_raya();
	}
